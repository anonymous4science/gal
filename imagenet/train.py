...
def train_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        if not args.distributed:
            ...
            losses_std.append(loss.item()/input.size(0))
        ...
        # print(args.distributed, input.size(0), args.world_size)
        # sys.exit()
        ...
        if last_batch or batch_idx % args.log_interval == 0:
            ...
            if args.distributed:
                ...
                losses_std.append(reduced_loss.item()/input.size(0))
    ...
    losses_std = np.array(losses_std).std()
    return OrderedDict([('loss', losses_m.avg),('loss_std', losses_std),('proc_time', proc_time.avg)])
...
def validate(model, loader, loss_fn, args, log_suffix=''):
    ...
    losses_std = np.array(losses_std).std()
    metrics = OrderedDict([('loss', losses_m.avg), ('loss_std', losses_std), ('prec1', prec1_m.avg), ('prec5', prec5_m.avg)])
