...
#-----------choose one block for plotting------------
input_file = 'figures_gd/z_results.npz'
output_svg = 'figures_gd/'
print_range = 60

# input_file = 'figures_lagd/z_results.npz'
# output_svg = 'figures_lagd/'
# print_range = 600
...
# input_file = 'figures_adabound/z_results.npz'
# output_svg = 'figures_adabound/'
# print_range = 300
#---------------------------------------------------------
